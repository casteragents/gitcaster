...
export const evidenceLinks: EvidenceLink[] = [
  ...
  { label: "Protocol types source", path: "packages/protocol", status: "public-alpha" },
  { label: "Protocol types notes", path: "docs/protocol-types.md", status: "public-alpha" },
  { label: "Protocol types evidence", path: "launch/evidence/protocol-types-public-alpha.json", status: "public-alpha" },
  { label: "Protocol types public smoke", path: "launch/evidence/protocol-types-public-smoke.json", status: "public-alpha" },
  { label: "CasterDID identity source", path: "packages/identity", status: "public-alpha" },
  { label: "CasterDID identity fixture", path: "examples/identity/local-casterdid-identity.example.json", status: "public-alpha" },
  { label: "CasterDID identity notes", path: "docs/casterdid-identity.md", status: "public-alpha" },
  { label: "CasterDID identity evidence", path: "launch/evidence/casterdid-identity-public-alpha.json", status: "public-alpha" },
  { label: "CasterDID identity public smoke", path: "launch/evidence/casterdid-identity-public-smoke.json", status: "public-alpha" },
