...
export function truthTableRows(): TruthTableRow[] {
  return [
    ...
    { surface: "protocol package", status: "public-alpha", evidence: "packages/protocol; examples/protocol/local-protocol-envelope.example.json; docs/protocol-types.md; apps/web/app/open-source/protocol-types/page.tsx; apps/web/public/gitcaster-protocol-types.json; launch/evidence/protocol-types-public-alpha.json; launch/evidence/protocol-types-public-smoke.json", nextProof: "Published package artifact, downstream compatibility checks, public runtime endpoint, managed custody, storage, domain, rollback, and release-candidate proof" },
    { surface: "identity package", status: "public-alpha", evidence: "packages/identity; examples/identity/local-casterdid-identity.example.json; docs/casterdid-identity.md; apps/web/app/open-source/casterdid-identity/page.tsx; apps/web/public/gitcaster-casterdid-identity.json; launch/evidence/casterdid-identity-public-alpha.json; launch/evidence/casterdid-identity-public-smoke.json", nextProof: "Published package artifact, managed custody review, public runtime endpoint, node mutation, storage, domain, rollback, and release-candidate proof" },
