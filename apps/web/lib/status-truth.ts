...
export function truthTableRows(): TruthTableRow[] {
  return [
    ...
    { surface: "agent skills notes", status: "public-alpha", evidence: "docs/agent-skills.md; apps/web/app/open-source/agent-skills/page.tsx; apps/web/public/gitcaster-agent-skills.json", nextProof: "Public gateway, managed custody, node mutation, storage, domain, rollback, and release-candidate proof" },
