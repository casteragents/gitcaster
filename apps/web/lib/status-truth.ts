...
export function truthTableRows(): TruthTableRow[] {
  return [
    ...
    { surface: "Caster Intelligence preview shell", status: "public-alpha", evidence: "apps/web/app/ecosystem/caster-intelligence/page.tsx; apps/web/app/open-source/caster-intelligence-preview/page.tsx; apps/web/public/gitcaster-caster-intelligence-preview.json", nextProof: "Public user browser smoke, source rights review, native storage, native domain, runtime endpoint, and rollback proof" },
